...
def test_usage_ratio_is_final_override_not_secondary_multiplier():
    ...
    assert 'param["hs_effective_ratio"] = effective_ratio' in patched
    assert 'param.get("hs_effective_ratio", coeff)' in patched
    assert 'p.get("hs_effective_ratio", coeff)' in patched
...
if __name__ == '__main__':
    ...
    test_usage_ratio_is_final_override_not_secondary_multiplier()
