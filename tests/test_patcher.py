...
def test_usage_ratio_is_node_plus_host_offset_with_legacy_fallback():
    ...
    assert 'param.get("hs_absolute_ratio"' in patched
    assert 'p.get("hs_absolute_ratio"' in patched
...
if __name__ == '__main__':
    ...
    test_usage_ratio_is_node_plus_host_offset_with_legacy_fallback()
